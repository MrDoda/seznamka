...
abstract class NFormControl extends NComponent implements IFormControl
{
	 ...
	 * @return bool
	 */
	public static function validateNotEqual(IFormControl $control, $arg)
	{
		return !self::validateEqual($control, $arg);
	}
	 ...
	 * @return bool
	 */
	public static function validateBlank(IFormControl $control)
	{
		return !$control->isFilled();
	}
