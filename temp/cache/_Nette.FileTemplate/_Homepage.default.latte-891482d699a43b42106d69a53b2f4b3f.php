<?php //netteCache[01]000338a:2:{s:4:"time";s:21:"0.29543300 1395065235";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:9:"checkFile";}i:1;s:57:"C:\wamp\www\seznamka\app\templates\Homepage\default.latte";i:2;i:1390051654;}i:1;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:20:"NFramework::REVISION";i:2;s:22:"released on 2014-01-01";}}}?><?php

// source file: C:\wamp\www\seznamka\app\templates\Homepage\default.latte

?><?php
// prolog NCoreMacros
list($_l, $_g) = NCoreMacros::initRuntime($template, '7q1wt1h8xh')
;
// prolog NUIMacros
//
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb8d6486d7f3_content')) { function _lb8d6486d7f3_content($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
<div id="content">
	...
	<section id="template">
		...
		<pre><code class="jush"><?php echo NTemplateHelpers::escapeHtml($template->replacere(file_get_contents($presenter->template->getFile()), '#[\w+/]{60,}#', '…'), ENT_NOQUOTES) ?></code></pre>
	</section>
	...
	<footer>PHP <?php echo NTemplateHelpers::escapeHtml(PHP_VERSION, ENT_NOQUOTES) ?> |
		<?php if (isset($_SERVER['SERVER_SOFTWARE'])) { ?>Server <?php echo NTemplateHelpers::escapeHtml($_SERVER['SERVER_SOFTWARE'], ENT_NOQUOTES) ;} ?> |
...
// block title
//
if (!function_exists($_l->blocks['title'][] = '_lbc9fec2bea1_title')) { function _lbc9fec2bea1_title($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_l->blocks['scripts'][] = '_lb71434cae4c_scripts')) { function _lb71434cae4c_scripts($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;NUIMacros::callBlockParent($_l, 'scripts', get_defined_vars()) ?>
...
// block head
//
if (!function_exists($_l->blocks['head'][] = '_lb5e38e5c3c9_head')) { function _lb5e38e5c3c9_head($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
